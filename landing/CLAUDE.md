...
**Ниже порога, осознанно:** `Flower 2 - Cover` (IoU 0.497) стоит через `BELOW_PASS_OK`.
Угол подтверждён независимо двумя разными кадрами (77.1 на окне 119×99 и 76.6 на 260×99) —
совпадение замеров по разным окнам весит больше самой метрики, которая на плотном листе в
узкой полосе штрафует за доли градуса.

**Тариф 4 — исключение из всей схемы: готовые срезы из Figma** (`public/SVG/plans/decor/`,
