 ...
 * переключаться тем же триггером, что и сама `.glass`, — `:hover` на указательных
 * устройствах, — а это медиазапрос, которого инлайн-стиль не умеет. Растение на полной
 * непрозрачности поверх полупрозрачной карточки сломало бы стекло.
 *
