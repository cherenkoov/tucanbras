  ...
  return (
    <div className={`pointer-events-none select-none ${className}`} aria-hidden="true">
      ...
      >
        ...
        {/* ── Beak (base + luminance-masked shading) ── */}
        ...
        <g className="tucan-footer-wing">
          <path d="M30 197 C 12 186, 3 168, 12 158 C 20 148, 35 152, 38 167 C 42 182, 38 198, 30 197 Z" fill="#282B2E"/>
        </g>

        {/* ── Eyelids (animated blink, clipped to eye socket) ── */}
        <g clipPath="url(#tucan-ft-eye-clip)">
          <g className="tucan-lid-upper">
            <path d="M41.3 70.9 A 6.1 9.8 0 0 1 53.5 70.9 Z" fill="#FEF1CA"/>
          </g>
        </g>
        <g clipPath="url(#tucan-ft-eye-clip)">
          <g className="tucan-lid-lower">
            <path d="M41.3 70.9 A 6.1 9.8 0 0 0 53.5 70.9 Z" fill="#FEF1CA"/>
          </g>
        </g>
      </svg>
    </div>
    ...
    <footer id="footer" className="w-full scroll-mt-[136px] lg:scroll-mt-[147px]">
      ...
      >
        ...
        >
          ...
          {/* ── Bottom bar: copyright + tucan + language ── */}
